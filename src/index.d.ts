...
export declare class WidgetSDKInstance {
    ...
    showDialog(text: string, buttons?: ShowDialogButton[]): Promise<WidgetMessage>;
    ...
    validationFeedback(valid: boolean, messageText?: string, changeMessageId?: number): WidgetMessage | null;
    showPopup(popupName: string, popupParameters?: WidgetMessage): Promise<WidgetMessage>;
